...
public class MFVec3d extends AbstractList<SFVec3d> {

	double[] data;

	public MFVec3d(double[] data) {
		set(data);
	}
	...
	public void set(double[] data) {
		if (data.length % 3 != 0)
			throw new IllegalArgumentException(
					"Data of MFVec3d needs to be multiple of 3.");
	 ...
	 */
	@Override
	public SFVec3d get(int index) {
		if (index >= size())
			throw new ArrayIndexOutOfBoundsException("index=" + index
					+ ", size=" + size());
		int pos = index * 3;
		return new SFVec3d(this.data[pos], this.data[pos + 1],
				this.data[pos + 2]);
	}
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof MFVec3d))
			return false;

		MFVec3d that = (MFVec3d) obj;
