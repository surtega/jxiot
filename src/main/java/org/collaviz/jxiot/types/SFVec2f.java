...
public class SFVec2f {
	...
	/**
	 * Constructs and initializes a SFVec2f from the specified xy coordinates.
	 * 
	 * @param x
	 *            the x coordinate
	 * @param y
	...
	/**
	 * Constructs and initializes a SFVec2f from the specified array.
	 * 
	 * @param t
	 *            the array of length 2 containing xy in order
	 */
	public SFVec2f(float t[]) {
		set(t);
	}
