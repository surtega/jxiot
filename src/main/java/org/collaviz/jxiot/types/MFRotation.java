...
public class MFRotation extends Float4Array<SFRotation> {

	public MFRotation(float[] data) {
		super(data);
	}

	@Override
	protected SFRotation createType(float x, float y, float z, float w) {
	...
	public boolean equals(Object obj) {
		...
		MFRotation that = (MFRotation) obj;
