...
public class MFVec4d extends AbstractList<SFVec4d> {

	double[] data;

	public MFVec4d(double[] data) {
		set(data);
	}
	...
	public void set(double[] data) {
		if (data.length % 4 != 0)
			throw new IllegalArgumentException(
					"Data of MFVec4d needs to be multiple of 4.");
	 ...
	 */
	@Override
	public SFVec4d get(int index) {
		if (index >= size())
			throw new ArrayIndexOutOfBoundsException("index=" + index
					+ ", size=" + size());
		int pos = index * 4;
		return new SFVec4d(this.data[pos], this.data[pos + 1],
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof MFVec4d))
			return false;

		MFVec4d that = (MFVec4d) obj;
